...
bool Game::Initialize(const char* WindowName,int WindowX,int WindowY,int WindowWidth,int WindowHeight,int flags ){
	...
	p=new Protagonist(50,40,"Alan.png",m_p_Renderer,3,96,32);
	d=new DemonChild(550,40,"DemonBaby.png",m_p_Renderer,3,96,32);
...
void Game::Update(){
	...
	p->Update(m_p_Renderer,d->boundingBox);
	d->Update(m_p_Renderer,p->boundingBox);
}
